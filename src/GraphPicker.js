    ...
    render() {
        ...
        return (
            <div className="GraphPicker">
                ...
                <div className="card" onClick={this.handleClick1.bind(this)}>
                    Demand-Supply
                    <VegaRenderer
                         vegaSpec={graphs.demandSupply}
                         renderer={'svg'} />
                </div>
                <div className="card" onClick={this.handleClick2.bind(this)}>
                    Labor Market
                    <VegaRenderer vegaSpec={graphs.laborMarket} renderer={'svg'} />
                </div>
                <div className="card" onClick={this.handleClick3.bind(this)}>
                    Capital Market
