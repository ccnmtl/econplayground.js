...
const exportGraph = function(state) {
    let obj = {
        ...
        intersection_2_label_editable: state.gIntersection2LabelEditable,
        intersection_3_label: state.gIntersection3Label,
        intersection_3_label_editable: state.gIntersection3LabelEditable,
        ...
        line_3_slope_editable: state.gLine3SlopeEditable,
        ...
        line_3_label_editable: state.gLine3LabelEditable,

        line_1_dashed: state.gLine1Dashed,
        line_1_dashed_editable: state.gLine1DashedEditable,
        line_2_dashed: state.gLine2Dashed,
        line_2_dashed_editable: state.gLine2DashedEditable,
        line_3_dashed: state.gLine3Dashed,
        line_3_dashed_editable: state.gLine3DashedEditable,
...
const importGraph = function(json, obj) {
    const updateObj = {
        ...
        gIntersection2LabelEditable: json.intersection_2_label_editable,
        gIntersection3Label: json.intersection_3_label,
        gIntersection3LabelEditable: json.intersection_3_label_editable,
        ...
        gLine3SlopeEditable: json.line_3_slope_editable,
        ...
        gLine3LabelEditable: json.line_3_label_editable,

        gLine1Dashed: json.line_1_dashed,
        gLine1DashedEditable: json.line_1_dashed_editable,
        gLine2Dashed: json.line_2_dashed,
        gLine2DashedEditable: json.line_2_dashed_editable,
        gLine3Dashed: json.line_3_dashed,
        gLine3DashedEditable: json.line_3_dashed_editable,
...
const defaultGraph = {
    ...
    gIntersection2Label: '',
    gIntersection2LabelEditable: false,
    gIntersection3Label: '',
    gIntersection3LabelEditable: false,
    ...
    gLine1Dashed: false,
    gLine1DashedEditable: false,
    gLine2Dashed: false,
    gLine2DashedEditable: false,
    gLine3Dashed: false,
    gLine3DashedEditable: false,
    gXAxisLabel: '',
