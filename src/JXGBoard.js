    ...
    renderJXBoard(options) {
        ...
        if (typeof options.gType === 'number') {
            graphTypes[options.gType](board, {
                ...
                gLine1OffsetInitial: options.gLine1OffsetInitial,
                ...
                gLine2OffsetInitial: options.gLine2OffsetInitial,
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (needsUpdate) {
            this.renderJXBoard({
                ...
                gLine1OffsetInitial: nextProps.gLine1OffsetInitial,
                ...
                gLine2OffsetInitial: nextProps.gLine2OffsetInitial,
